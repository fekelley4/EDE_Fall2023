...
EPAAir_2019$Date <- as.Date(EPAAir_2019$Date)
EPAAir_P25_2018$Date <- as.Date(EPAAir_P25_2018$Date)
EPAAir_P25_2019$Date <- as.Date(EPAAir_P25_2019$Date)
...
EPAAir_2018_select <- select(EPAAir_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
EPAAir_2019_select <- select(EPAAir_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
P25_2018_select <- select(EPAAir_P25_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
P25_2019_select <- select(EPAAir_P25_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
P25_2018_processed <- mutate(P25_2018_select, AQS_PARAMETER_DESC == "PM2.5")
P25_2019_processed <- mutate(P25_2019_select, AQS_PARAMETER_DESC == "PM2.5")
